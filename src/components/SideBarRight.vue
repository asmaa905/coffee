   ...
   <v-navigation-drawer app color="white" right width="290">
       ...
       <v-list subheader two-line class="mt-1">
        <v-list-item>
            ...
            <v-list-item-content>
                <v-list-item-title class="subtitle-2">Caramel Frappucino</v-list-item-title>
       ...
       <v-toolbar color="rgba(0,0,0,0)" flat>
          <v-spacer><strong>Subtotal</strong></v-spacer>
          <v-spacer><strong>$18.31</strong></v-spacer>

       </v-toolbar>
       <v-toolbar color="rgba(0,0,0,0)" flat class="mt-n6">
        <v-spacer><span>Tax(10%)</span></v-spacer>
            <v-spacer><span>$18.31</span></v-spacer>
       </v-toolbar>
                          ...
                          <v-row>
                            <v-col cols="12" md="12">
                                ...
                                <v-list-item-content>
                                    ...
                                    <v-list-item-subtitle 
                                    :class="active?'brown--text':'black--text'" class="mt-n2 caption">
